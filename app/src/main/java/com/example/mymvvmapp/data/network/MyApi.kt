...
import com.example.mymvvmapp.data.network.responses.QuotesResponse
...
interface MyApi {
    ...
    companion object {
        operator fun invoke(
            ...
            return Retrofit.Builder().client(okHttpClient).baseUrl("https://api.simplifiedcoding.in/course-apis/mvvm/")
